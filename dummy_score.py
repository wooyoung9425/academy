...
from appointment import appointment_v2
from participation import participation_v2
from degreeOfInterest import interest_v2
...
interest = interest_v2(df_search_history, df_click_academy)
participation = participation_v2(
    df_click_academy, df_favorite_academy, df_appointment)
appointment = appointment_v2(df_appointment)
...
df_score.to_csv(
    './result/dummy_score.csv', encoding='utf-8', index=False)
